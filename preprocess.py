...
nltk.download('punkt')
# nltk.download('punkt_tab') # This line had a typo in your original file
nltk.download('stopwords')
...
# --- !! HERE IS THE FIX !! ---
logging.info("💾 Converting matrix to float32 to reduce size...")
cosine_sim = cosine_sim.astype(np.float32)
# -----------------------------

logging.info("✅ Cosine similarity matrix generated and converted.")

# Save everything
joblib.dump(df, 'df_cleaned.pkl')
# joblib.dump(tfidf_matrix, 'tfidf_matrix.pkl') # You can comment this out, recommend.py doesn't use it
joblib.dump(cosine_sim, 'cosine_sim.pkl')
logging.info("💾 Data saved to disk.")
